...
|------|--------|----------|--------|------|-------|--------|--------|-----------|
| SEC-NET-002 | security | prod | - | networking.public_access | False | override-allowed | SEC-NET-002 (Secure network communications, L488, 2026-05-14) | Production data should not be publicly reachable by default. |
| SEC-NET-003 | security | prod | - | networking.ip_firewall | False | override-allowed | SEC-NET-003 (Secure network communications, L514, 2026-05-14) | Limit which networks can reach Fabric. |
| REL-RED-001 | reliability | prod | - | disaster_recovery | False | override-allowed | REL-RED-001 (Build self-healing through redundancy, L278, 2026-05-14) | Region-level redundancy for critical data. |
| OPS-OLS-001 | operational_excellence | prod | prod | workspace.onelake_security.enabled | False | override-allowed | OPS-OLS-001 (Deploy changes safely, L992, 2026-05-14) | Consistent governance of production data. |
| REL-SCL-001 | reliability | prod | - | surge_protection.enabled | True | override-allowed | REL-SCL-001 (Scale vertically and horizontally, L312, 2026-05-14) | Cap runaway background/overage usage; absorb spikes without surprise cost. |
...
- terraform validate dev/foundation: passed
- terraform validate dev/platform: passed
- terraform validate dev/content: passed
- terraform validate prod/foundation: passed
- terraform validate prod/platform: passed
- terraform validate prod/content: passed
